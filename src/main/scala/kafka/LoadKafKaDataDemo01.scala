...
/**
  ...
  */
object LoadKafkaDataDemo01 {
    def main(args: Array[String]): Unit = {
        val checkpointDir = "E:\\Test-workspace\\testSpark\\checkPoint\\2019-08-14"
    ...
    def createContext = {
        ...
        ssc.checkpoint("E:\\Test-workspace\\testSpark\\checkPoint\\2019-08-14-01")
